...
static void add_mitigations(HANDLE hProc)
{
    ...
    aslrPolicy.EnableBottomUpRandomization = 0;
    aslrPolicy.EnableForceRelocateImages = 0;
    aslrPolicy.EnableHighEntropy = 0;
    aslrPolicy.DisallowStrippedImages = 0;
    ...
    extensionPointPolicy.DisableExtensionPoints = 0;
    ...
    controlFlowGuardPolicy.EnableControlFlowGuard = 0;
    controlFlowGuardPolicy.EnableExportSuppression = 0;
    controlFlowGuardPolicy.StrictMode = 0;
    ...
    binarySignaturePolicy.MicrosoftSignedOnly = 0;
    binarySignaturePolicy.StoreSignedOnly = 0;
    binarySignaturePolicy.MitigationOptIn = 0;
    ...
    imageLoadPolicy.NoRemoteImages = 0;
    imageLoadPolicy.NoLowMandatoryLabelImages = 0;
    imageLoadPolicy.PreferSystem32Images = 0;
    ...
    fontDisablePolicy.DisableNonSystemFonts = 0;
    fontDisablePolicy.AuditNonSystemFontLoading = 0;
